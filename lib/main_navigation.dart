...
class _AdminMainNavigationState
  ...
  void configureNavigation() {
    ...
    /*
     * Head Office controls the states where
     * ServicePay Delivery is live.
     */
    if (isHeadOffice) {
      addNavigationPage(
        page:
    ...
    /*
     * Settings is available to every
     * authorized admin or staff account.
     */
    addNavigationPage(
